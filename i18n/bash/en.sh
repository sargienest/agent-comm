...
ac_i18n_register "message.command_pending" $'A new command is available.\nfile: {command_file}\npersonas: {personas_manifest}\n\nAct immediately in this order:\n1. mark the command inflight\n2. create the investigation task\n3. create the analyst task\n4. stop and wait for their completion notifications\n\nDo not inspect unrelated repository files or runtime internals before creating those first two tasks unless the command explicitly requires it.\n\ncommand:\n{command_text}'
